...
public class CustomLookupStrategy implements LookupStrategy {
  ...
  private static final String DEFAULT_SELECT_CLAUSE_ACL_CLASS_ID_TYPE_COLUMN = ", acl_class.class  ";
  ...
  private CustomAclClassIdUtils aclClassIdUtils;
  ...
  public CustomLookupStrategy(DataSource dataSource, AclCache aclCache,
    ...
    this.aclClassIdUtils = new CustomAclClassIdUtils();
  ...
  public final void setConversionService(ConversionService conversionService) {
    this.aclClassIdUtils = new CustomAclClassIdUtils(conversionService);
  }
